...
Stone Vendas segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Stone** | BR | adquirente (API de Conciliação, provedor dos dados do usuário) |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [stone_vendas@mcp.ai](mailto:stone_vendas@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
